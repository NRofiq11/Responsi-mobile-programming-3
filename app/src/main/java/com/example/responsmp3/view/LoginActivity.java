...
import com.example.responsmp3.repositori.DBHelper;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvForgotPassword.setText(fromHtml("Fogot Password ? Click. " + "</font><font color='#FF7600'>Here</font>"));
        ...
        tvCreateAccount.setText(fromHtml("I don't have account yet. " +
                "</font><font color='#FF7600'>Create</font>"));
